...
| Файл | Размер |
|------|--------|
| `cursor-backup.part01.rar` … `part02.rar` | по 100 MiB |
| `cursor-backup.part03.rar` | ~23 MiB |

**Всего ~224 МБ** (3 тома RAR).
...
- Убедитесь, что скачаны **все** части `part01`–`part03`, не только указатели LFS.
